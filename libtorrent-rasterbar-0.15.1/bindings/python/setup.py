...
extra_cmd = '-DTORRENT_USE_OPENSSL -DWITH_SHIPPED_GEOIP_H -DBOOST_ASIO_HASH_MAP_BUCKETS=1021 -DBOOST_EXCEPTION_DISABLE -DTORRENT_LINKING_SHARED  -I/usr/include  -lz -lrt   -lboost_system-1_35 -lboost_filesystem-1_35 -lboost_thread-1_35   -lssl -lcrypto -ldl      '
